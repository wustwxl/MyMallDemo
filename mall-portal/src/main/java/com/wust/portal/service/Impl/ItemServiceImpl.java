...
import com.wust.portal.pojo.ItemInfo;
import com.wust.portal.service.ItemService;
...
public class ItemServiceImpl implements ItemService {
	...
	public ItemInfo getItemById(Long itemId) {
		...
		try {
			...
			if (!StringUtils.isBlank(json)) {
				MallResult taotaoResult = MallResult.formatToPojo(json, ItemInfo.class);
	...
	public String getItemDescById(Long itemId) {
		try {
			...
			//转换成java对象
			MallResult taotaoResult = MallResult.formatToPojo(json, TbItemDesc.class);
			if (taotaoResult.getStatus() == 200) {
	...
	public String getItemParam(Long itemId) {
		try {
			...
			//把json转换成java对象
			MallResult taotaoResult = MallResult.formatToPojo(json, TbItemParamItem.class);
			if (taotaoResult.getStatus() == 200) {
